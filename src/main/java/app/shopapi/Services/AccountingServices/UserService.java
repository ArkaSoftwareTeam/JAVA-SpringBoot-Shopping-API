...
public class UserService implements IUserService{
    ...
    @Autowired
    public UserService(IUserRepository userRepo, IRoleRepository roleRepo, IAddressRepository addressRepo, ICartService cartService, PasswordEncoder passwordEncoder, ModelMapper modelMapper) {
    ...
    public UserDTO registerUser(UserDTO userDTO) {
        try {
            ...
            Address address = addressRepo.findByCountryAndCityAndStreet(country,city,street);
