...
import app.shopapi.Services.FileServices.IFileService;
...
public class ProductService implements IProductService {
    ...
    @Autowired
    public ProductService(IProductRepository productRepo, ICategoryRepository categoryRepo, ICartRepository cartRepo, ICartService cartService, IFileService fileService, ModelMapper modelMapper) {
