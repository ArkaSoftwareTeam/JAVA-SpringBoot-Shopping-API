...
import app.shopapi.DTOs.LoginCredentialsDTO;
import app.shopapi.DTOs.UserDTO;
import app.shopapi.Exceptions.UserNotFoundException;
import app.shopapi.Secutiry.JWTUtil;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public Map<String, Object> loginHandler(@Valid @RequestBody LoginCredentialsDTO credentials) {
