...
public class ProductController {
    ...
    public ResponseEntity<ProductResponseDTO> getAllProducts(
        ...
        return new ResponseEntity<ProductResponseDTO>(productResponse, HttpStatus.FOUND);
    }
    ...
    public ResponseEntity<ProductResponseDTO> getProductsByKeyword(@PathVariable String keyword,
        ...
        ProductResponseDTO productResponse = productService.searchProductByKeyword(keyword, pageNumber, pageSize, sortBy,
                sortOrder);
